...
def iter_backup_file(fullname):
    ...
    while True:
        ...
        yield filesize, timestamp, utfnamesize, numblocks, last_backup_timestamp, fullname, blocks
    f.close()
        ...
        for dirpath, dirnames, filenames in os.walk(self.backupdir, onerror=walkerror):
            for filename in filenames:
                ...
                if hashes is not None:
                    ...
                    logger.debug("done with file %s" % repr(fullname))
